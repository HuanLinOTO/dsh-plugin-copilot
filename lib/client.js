...
*/
function CopilotAuthCard({ view, t, controller, useCard }) {
	...
	const badges = state.status.loggedIn ? [{
		tone: "ok",
		label: t("card.signedIn")
	}, {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			style: bodyStyle,
			children: [
				badges.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: badgeRowStyle,
					children: badges.map((badge) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
